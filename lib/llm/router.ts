...
export async function routeToProvider(
  ...
  switch (modelId) {
    ...
    default:
      throw new Error(
        `Unsupported model: ${modelId}. Supported models: gpt-5-mini, gpt-5.2, claude-opus-4-6, claude-sonnet-4-5-20250929, claude-haiku-4-5-20251001, gemini-3-flash-preview, gemini-3-pro-preview`
      );
  }
}
